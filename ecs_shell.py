...
def list_services(profile_name, ecs_client, cluster_name):
    ...
    try:
        ...
        console.print("[yellow]This usually means your session has expired or is not configured.[/yellow]\n")
        ...
        console.print("     [dim]$[/dim] [green]aws sso login --sso-session <your-sso-session-name>[/green]\n")
        sys.exit(1)
